...
export default function BlogPost(props) {
  let blog = {
    ...
    content:
      "A structure used in most apps and games. It's a way to keep doing the same. While a condition is true, Or for one to twenty-two. If endless, for errors we blame ..........Loop",
    imageSrc:
